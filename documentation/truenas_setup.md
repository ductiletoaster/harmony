...
```
traefik.enable=true
traefik.http.routers.portainer.rule=Host(`portainer001.local.pixeloven.com`)
...
```
traefik.http.routers.portainer-edge.rule=Host(`portainer-edge001.local.pixeloven.com`)
